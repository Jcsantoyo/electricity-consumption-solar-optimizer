...
def calculate_total_installation_cost(
    ...
    battery_cost = calculate_battery_installation_cost(battery_capacity_kwh, battery_cost_per_kwh)
    
    solar_cost = calculate_solar_installation_cost(solar_peak_power_kw, solar_cost_per_kw)

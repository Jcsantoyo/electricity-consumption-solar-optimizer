...
def build_run_manifest(
    ...
    consumption_metadata = build_dataset_metadata(consumption_df, scenario.consumption_data_path)
    ...
    if price_df is not None:
        ...
        price_metadata = build_dataset_metadata(price_df, scenario.hourly_price_data_path)
    ...
    return {
        ...
        "scenario": {
            ...
            "use_pvgis_solar_data": (
                scenario.use_pvgis_solar_data
            ),
            "pvgis_solar_data_path": (
                scenario.pvgis_solar_data_path
            ),

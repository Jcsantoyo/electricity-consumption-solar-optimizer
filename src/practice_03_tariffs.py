...
variable_total_cost, variable_hourly_costs_eur, hourly_prices_eur_per_kwh = calculate_variable_tariff_cost(daily_hourly_consumption_kwh)

print(f"\nVariable total cost: {variable_total_cost:.2f} EUR")

fixed_price_per_kwh = 0.18

fixed_total_cost = calculate_fixed_tariff_cost(daily_hourly_consumption_kwh, fixed_price_per_kwh)

...
plt.plot(
    df["solar_peak_power_kw"],
    df["self_sufficiency_with_battery"],
    marker="o"
)
...
plt.savefig("images/self_sufficiency_vs_solar_peak_power.png", dpi=300, bbox_inches="tight")
...
plt.savefig("images/solar_surplus_vs_solar_peak_power.png", dpi=300, bbox_inches="tight")
